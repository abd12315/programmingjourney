...
char=input("The rules are simple first choose your character  Please write the name exact as given i.e Ahmed,Waqar,Rehman: ")
if char==players[0]:
...
if attack_points[0]>attack_points[1] and attack_points[0]>attack_points[2]:
    print(f"based on the weapon power congraculatiion to {players[0]} is the winner ")
elif char==players[1]:
...
if attack_points[1]>attack_points[0] and attack_points[1]>attack_points[2]:
    print(f"based on the weapon power congraculatiion  to {players[1]} is the winner " )
elif char==players[2]:
...
if attack_points[2]>attack_points[1] and attack_points[2]>attack_points[0]:
    print(f" based on the weapon power congraculatiion  to {players[2]} you've cleared the stage ")
else:
